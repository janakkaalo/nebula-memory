...
/**
 * Cinematic AAA cosmic environment behind the whole site.
 * Domain-warped nebula shader + twinkling star layers + dust +
 * glow sprites + periodic shooting stars + scroll / parallax camera.
 * Pauses on hidden tabs, caps pixel ratio for mobile.
 */
export default function NebulaBackground() {
  ...
  useEffect(() => {
    ...
    // ── AAA nebula shader: domain-warped fbm, 3 color fields ──
    ...
    // aurora band (second translucent plane)
